...
public class CeteCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        switch (sub) {
            ...
            case "reload": {
                if (!sender.hasPermission("cete.admin")) {
                    sender.sendMessage(msg("no-permission", "&cYetkin yok."));
                    break;
                }
                
                plugin.reloadPlugin();
                sender.sendMessage(msg("reload-success", "&aPlugin ve config yenilendi."));
                break;
            }
